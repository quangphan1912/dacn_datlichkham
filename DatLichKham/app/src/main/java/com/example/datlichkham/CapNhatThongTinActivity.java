...
public class CapNhatThongTinActivity extends AppCompatActivity {
    private TextInputLayout tilUsername, tilHoTen, tilMail, tilBirthday, tilAge, tilPhone, tilAddress;
    ...
    private void showAllUserData(String username) {
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                tilAddress.getEditText().setText(addressFromDB);
    ...
    private void updateInfor() {
        findViewById(R.id.btn_ok_capNhatActivity).setOnClickListener(v -> {
            ...
            if(checkError){
                ...
                reference.child("address").setValue(tilAddress.getEditText().getText().toString().trim());
    ...
    private void mappingView() {
        ...
        tilAddress =findViewById(R.id.til_address_capNhatActivity);
    }
}